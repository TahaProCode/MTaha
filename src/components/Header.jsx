  ...
  return (
    ...
    >
      ...
      <nav
        ...
        } md:flex flex-col md:flex-row gap-4 px-4 py-2 absolute md:static top-16 left-0 w-full md:w-auto bg-black/90 md:bg-transparent transition-all duration-300`}
      >
        <Link to="/Home">
          <motion.a
